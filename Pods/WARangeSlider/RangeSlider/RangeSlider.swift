...
public class RangeSlider: UIControl {
    @IBInspectable public var minimumValue: Double = 5 {
        willSet(newValue) {
    ...
    @IBInspectable public var maximumValue: Double = 300 {
        willSet(newValue) {
    ...
    @IBInspectable public var lowerValue: Double = 5{
        didSet {
    ...
    @IBInspectable public var upperValue: Double = 200 {
        didSet {
    ...
    func updateLayerFrames() {
        ...
        lowerThumbLayer.frame = CGRect(x: lowerThumbCenter - thumbWidth/2.0, y: -5, width: thumbWidth, height: thumbWidth)
        lowerThumbLayer.setNeedsDisplay()
        
        let upperThumbCenter = CGFloat(positionForValue(upperValue))
        upperThumbLayer.frame = CGRect(x: upperThumbCenter - thumbWidth/2.0, y: -5, width: thumbWidth, height: thumbWidth)
        upperThumbLayer.setNeedsDisplay()
